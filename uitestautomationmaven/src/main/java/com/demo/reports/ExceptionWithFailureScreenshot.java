...
//		htmlreport.config().setReportName("Srinivas  Rapelli");
//		reports.setSystemInfo("Host Name", "Windows 11");
//		reports.setSystemInfo("Environment", "QA- Automation Testing");
//		reports.setSystemInfo("User Name", "RSrinu");
//		reports.setSystemInfo("browser", "Chrome");
//		reports.setSystemInfo("Site url", "http://www.google.com");
